...
Entity::Entity() : mPosition {0.0f, 0.0f}, mMovement {0.0f, 0.0f}, 
                   ...
                   mSpriteSheetDimensions {}, mAnimState {ENTITY_RIGHT}, 
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
    ...
    mTextureType {SINGLE}, mAnimState {ENTITY_RIGHT}, mAnimationAtlas {{}}, 
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
        ...
        mAnimationAtlas {animationAtlas}, mAnimState {ENTITY_RIGHT},
        mAnimationIndices {animationAtlas.at(ENTITY_RIGHT)}, 
