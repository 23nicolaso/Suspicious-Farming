...
Entity::Entity() : mPosition {0.0f, 0.0f}, mMovement {0.0f, 0.0f}, 
                   ...
                   mSpriteSheetDimensions {}, mAnimState {0}, 
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
    ...
    mTextureType {SINGLE}, mAnimState {0}, mAnimationAtlas {{}}, 
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
        ...
        mAnimationAtlas {animationAtlas}, mAnimState {0},
        mAnimationIndices {animationAtlas.at(0)}, 
...
void Entity::render() const
{
    ...
    DrawTexturePro(
        ...
        mAngle, mRedFlashTime > 0.0f? RED : WHITE 
    );
    // displayCollider();
}
